...
var loadOtherScenes = function (scene) {
    ...
    menu = new DIALOG.Menu("Tools:", ["Audio Recorder", "Rig Developer", "Shape Key Fingers", "Eye Movement", "3D Rigs"], DIALOG.Panel.LAYOUT_VERTICAL);
    ...
    menu.assignMenuCallback(4, function(){hyperlink(base + "/Being/3D_rig_tester/index.html");} );
    menus.addSubPanel(menu);       
