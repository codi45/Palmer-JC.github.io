...
// I'M melting
// AY11^4+4!CRYING@10 M_M EH1 L T IH0 NG_
...
(function (VoiceSync) {
    ...
    var iAmMelting = (function (_super) {
         ...
         */
        iAmMelting.prototype.say = function(automaton, isLastSentence) {
            var ref = this;
            var deforms = new Array(8);
            deforms[0] = new QI.VertexDeformation("FACE", "BASIS", ["AY-IH", "CRYING_NM"], [1, 1], 262.5, null, null, {sound : ref});
            deforms[1] = new QI.VertexDeformation("FACE", "BASIS", ["B-M-P", "CRYING_NM"], [1, 1], 75, null, null, null);
            deforms[2] = new QI.VertexDeformation("FACE", "BASIS", ["B-M-P", "CRYING_NM"], [1, 1], 75, null, null, {millisBefore: 75});
            deforms[3] = new QI.VertexDeformation("FACE", "BASIS", ["AE-EH", "CRYING_NM"], [1, 1], 225, null, null, null);
            deforms[4] = new QI.VertexDeformation("FACE", "BASIS", ["L", "CRYING_NM"], [1, 1], 75, null, null, null);
            deforms[5] = new QI.VertexDeformation("FACE", "BASIS", ["AY-IH", "CRYING_NM"], [1, 1], 162, null, null, null);
            deforms[6] = new QI.VertexDeformation("FACE", "BASIS", [".", "CRYING_NM"], [1, 1], 75, null, null, null);
        ...
        iAmMelting.prototype.precompile = function(automaton) {
            ...
            newStateNames[0] = faceGrp.addComboDerivedKey("BASIS", ["AY-IH", "CRYING_NM"], [1, 1], null);
            newStateNames[1] = faceGrp.addComboDerivedKey("BASIS", ["B-M-P", "CRYING_NM"], [1, 1], null);
            newStateNames[2] = faceGrp.addComboDerivedKey("BASIS", ["B-M-P", "CRYING_NM"], [1, 1], null);
            newStateNames[3] = faceGrp.addComboDerivedKey("BASIS", ["AE-EH", "CRYING_NM"], [1, 1], null);
            newStateNames[4] = faceGrp.addComboDerivedKey("BASIS", ["L", "CRYING_NM"], [1, 1], null);
            newStateNames[5] = faceGrp.addComboDerivedKey("BASIS", ["AY-IH", "CRYING_NM"], [1, 1], null);
            newStateNames[6] = faceGrp.addComboDerivedKey("BASIS", [".", "CRYING_NM"], [1, 1], null);
        };
        /**
         * @returns QI.MotionEvent[], so these may be further paired with other events using syncPartner() or option.requireCompletionOf.
         */
        iAmMelting.prototype.sayCompiled = function(automaton, isLastSentence) {
            var ref = this;
            var deforms = new Array(8);
            ...
            deforms[5] = new QI.Deformation("FACE", newStateNames[5], 1, 162, null, null, null);
