...
(function (QI) {
    var GifMaker = (function () {
        function GifMaker(fileName, engine, frameRate) {
            ...
            this.encoder.setComment("Generated in QueuedInterpolation by jsgif");
...
(function (QI) {
    var Hair = (function (_super) {
        ...
        function Hair(name, scene, parent, source, doNotCloneChildren) {
            ...
            _this.seed = 0;
            _this.interStrandColorSpread = 0; // The maximum amount to randomly change the color of a thread
            _this.intraStrandColorSpread = 0;
            _this.color = new BABYLON.Color3(1, 1, 1);
            _this.emissiveColorScaling = 1;
         ...
         */
        Hair.prototype.assemble = function (strandNumVerts, rootRelativePositions, headBone, spineBone, longestStrand, stiffness) {
         ...
         */
        Hair.prototype._assignSegmentLengthSoFar = function (rootRelativePositions) {
        ...
        Hair.prototype.assignWeights = function () {
...
(function (QI) {
    var ZoomOutTransition = (function () {
         ...
         */
        ZoomOutTransition.prototype.initiate = function (meshes, overriddenMillis, overriddenSound, options) {
            ...
            var eventOptions = { pace: new QI.SinePace(QI.Pace.MODE_INOUT), privilegedEvent: true };
            if (sound)
