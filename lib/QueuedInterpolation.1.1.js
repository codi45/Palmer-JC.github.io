...
(function (QI) {
    var Hair = (function (_super) {
        ...
        Hair.prototype.assemble = function (strandNumVerts, rootRelativePositions, headBone, spineBone, longestStrand, stiffness) {
            ...
            //                if (normals[i] < 0) {
            //                    normals[i] = 0.5;
            //                    if (normals[i] < -.8) normals[i] = -.5;
            //                    else if (normals[i] > -.3) normals[i] = -.5;
            //                } else {
            //                    if (normals[i] > .8) normals[i] = .5;
            //                    else if (normals[i] < .3) normals[i] = .5;
            //                }
        ...
        Hair.prototype.assignWeights = function (headBone, spineBone, longestStrand, stiffness) {
        ...
        Hair.prototype.assignVertexColor = function () {
            ...
            if (!this.material) {
                this.material = new BABYLON.StandardMaterial(this.name + "_emissive", this.getScene());
                this.material.specularColor = new BABYLON.Color3(0, 0, 0);
                this.material.specularPower = 0;
            }
            var emissiveColor = this.color.scale(0.8);
            ...
            if (emissiveColor.b > 0.5)
                emissiveColor.b = 0.5;
            this.material.emissiveColor = this.color.scale(0.8);
        };
